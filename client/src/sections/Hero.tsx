        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl mb-8 max-w-lg">
              Inspiring communities through the transformative power of sports. 
              Building connections, fostering development and creating positive change.
            </p>
          ...
          >
            <img 
              src="https://images.unsplash.com/photo-1535131749006-b7f58c99034b?ixlib=rb-1.2.1&auto=format&fit=crop&w=1350&q=80" 
